  ...
  <div class="row">
    <div class="col-12">
      <nav class="navbar navbar-expand-lg navbar-light bg-light nav-position">
        <p>
          <a class="navbar-brand shopName" href="index.php">
            <img id="logo" src="img/Logo.jpg" alt="Logo" />Watch-Luxury</a>
        </p>
            ...
            <li class="nav-item active">
              <div class="dropdown option">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="#">Couple Type</a>
                  <a class="dropdown-item" href="#">Woman Type</a>
                  <a class="dropdown-item" href="#">Man Type</a>
                </div>
              </div>
            </li>
            <li class="nav-item active">
