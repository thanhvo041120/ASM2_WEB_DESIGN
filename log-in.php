      ...
      <div class="row">
        <div class="col-12">
          <nav class="navbar navbar-expand-lg navbar-light bg-light nav-position">
            <p>
              <a class="navbar-brand shopName" href="index.php"><img id="logo" src="img/Logo.jpg" alt="Logo" />
                Watch-Luxury
              </a>
            </p>
    ...
    <div class="cotainer-fluid formfill">
      <div class="row">
        <div class="col-12 formenter">
          <form action="Operate/HandleForLog-in.php" method="post">
            Username:<br>
